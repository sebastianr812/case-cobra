...
export const DesignConfigurator = ({
    imageUrl, configId, imageDimensions
}: Props) => {
    ...
    return (
        <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
            ...
            {/* configuration options for phone */}
                    ...
                    <div className="px-8 pb-12 pt-8">
                        ...
                        <div className="relative mt-4 h-full flex flex-col justify-between">
                            <div className="flex flex-col gap-6">
                                        ...
                                        {COLORS.map((color) => (
                                            ...
                                            >
                                                <span className={cn(
                                                    ...
                                                    color.value === "black" && "bg-zinc-900",
                                                    color.value === "blue" && "bg-blue-950",
                                                    color.value === "rose" && "bg-rose-950",
                                                )} />
                                            </Radio>
                                        ))}
                                    </div>
                                ...
                                {[MATERIALS, FINISHES]
                                    .map(({ name, options: selectableOptions }) => (
                                        <RadioGroup
                                            key={name}
                                            value={options[name]}
                                            onChange={(val) => {
